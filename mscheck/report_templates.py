...
def create_interactive_report_html(
    report_title,
    plot_figure,
    mass_spectra,
    json_encoder=None,
    ...
    if available_reports is None:
        ...
        available_reports = [{"title": report_title, "path": "#"}]
    ...
    script_path = os.path.join(
        os.path.dirname(__file__), "templates", "spectrum_lookup.js"
    )
    ...
    html_content = html_content.replace(
        "{{CURRENT_REPORT_INDEX}}", str(current_report_index)
    )
